              ...
              <CardContent className="p-8 md:p-12">
                <div className="text-center">
                  ...
                  <div className="flex justify-center mb-6">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`h-6 w-6 ${
                          i < testimonials[currentIndex].rating ? "fill-yellow-400 text-yellow-400" : "text-gray-300 dark:text-gray-500"
                        }`}
                      />
                    ))}
                  </div>
                  ...
                  <blockquote className="text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-8 leading-relaxed italic rtl:font-['Tajawal'] rtl:not-italic">
                    "{language === "ar" ? testimonials[currentIndex].comment : testimonials[currentIndex].commentEn}"
                  </blockquote>
